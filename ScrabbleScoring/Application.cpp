...
void Application::Load()
{
	...
	unsigned int NO = (int)ScrabbleBoard::EScoreMod::NO; // No score modifier
	unsigned int DL = (int)ScrabbleBoard::EScoreMod::DL; // Double Letter Score
	unsigned int TL = (int)ScrabbleBoard::EScoreMod::TL; // Tripple Letter Score
	unsigned int DW = (int)ScrabbleBoard::EScoreMod::DW; // Double Word Score
	unsigned int TW = (int)ScrabbleBoard::EScoreMod::TW; // Tripple Word Score

	// Initialise a 15x15 grid representing score modifiers for the scrabble board
	...
	// Define Rendering color config values
